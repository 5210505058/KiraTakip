...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Bina binam = new Bina("Lorem Ipsum", 31);


        EvSahibi sahip1 = new EvSahibi("Name1", "Surname1");
        EvSahibi sahip2 = new EvSahibi("Name2", "Surname2");

        Daire daire1 = new Daire("Ut enim ad minim veniam, quis nostrud exercitation ullamco ", 1);
        Daire daire2 = new Daire("Lorem ipsum dolor sit amet, consectetur adipiscing elit", 41);
